...
let orders = [];
let API_URL = localStorage.getItem('api_url') || 'https://script.google.com/macros/s/AKfycbzRM_e3jV8RhHM7paQlanQPOtI9mmiTcLBOrQy25MfdY1Xna1eiOgeb9DcWaoAt7HRm/exec';
...
let currentAuditConciliatedTotal = 0;
...
function renderAuditTables() {
    ...
    currentAuditConciliatedTotal = sumMatched;
...
async function saveAuditReport() {
    ...
    const payload = {
        fechaReporte: date,
        repartidor: driver,
        montoSistema: currentAuditConciliatedTotal,
        montoPOS: currentAuditConciliatedTotal,
